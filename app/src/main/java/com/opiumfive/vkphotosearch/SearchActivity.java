...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Double lat = getIntent().getDoubleExtra("lat", 55.75); // получаем координаты и выполняем запрос фото
        Double longi = getIntent().getDoubleExtra("long", 37.61);
        int radius = getIntent().getIntExtra("rad", 5000);
